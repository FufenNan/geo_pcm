...
MODEL_DIR=/home/haoyum3/PCM/Phased-Consistency-Model/sd1.5
OUTPUT_DIR="outputs/lora_64_$PREFIX"
PROJ_NAME="lora_64_formal_$PREFIX"
accelerate launch --config_file /home/haoyum3/PCM/Phased-Consistency-Model/code/text_to_image_sd15/config.yaml\
    --main_process_port 29500  train_pcm_lora_sd15_adv.py \
